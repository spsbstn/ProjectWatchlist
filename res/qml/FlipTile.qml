...
property int rand: Math.floor(Math.random() * (10 - 5 + 1)) + 5;
     ...
     GridView.onAdd:
        ...
        ParallelAnimation {
         ...
         NumberAnimation {
                target: flipable; easing.overshoot: 1.1; properties: "scale"; from: 0.0; to: 1.0; easing.type: Easing.OutBack; easing.amplitude: 2.0; easing.period: 1.5; duration:rand*100
            }
        NumberAnimation {
